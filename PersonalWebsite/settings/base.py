...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "christine-eidmann-website.onrender.com"]
...
# Additional directories for collectstatic
STATICFILES_DIRS = [
    BASE_DIR / 'static',  # points to CEidmann_Website/static
]
# Media (optional if you have uploads)
MEDIA_URL = '/media/'
